  ...
  return (
    <div>
      <div className='flex items-center mb-8'>
        <p className={`${inter.className} text-[#002269] text-[18px] md:text-[32px] `}>{bankProfile.lastName} {bankProfile.firstName[0]}. {bankProfile.fatherName[0]}.</p>
        <div className='flex flex-col gap-y-2 ml-auto'>
          <button onClick={() => setActive((prev) => (!prev))} className="flex items-center max-w-[136px] justify-between border border-[#eef2f9] bg-[#fbfcfe] px-4 py-1 rounded-lg  w-full transition duration-700">
          ...
          {active && <div className='absolute top-[180px] right-[36px] md:right-[100px] lg:right-[150px] bg-white transition duration-700 rounded-md z-50  min-w-[250px] max-h-auto shadow-lg'>
        ...
        <div className='w-full'>
          ...
          <div className='flex items-center gap-6 h-[88px] p-5 w-full rounded-[16px] bg-[#F9FAFB] mb-5 border border-[#eef2f9]'>
            <div className='flex items-center justify-center bg-white rounded-full w-12 h-12'>
              ...
              <Image src={bankProfile?.url} width={28} height={28} className='w-7 h-7 bg-white rounded-full' alt="Bank Logo" />
            </div>
            <p className='flex flex-col'>
              <span className={`${inter.className} text-sm mb-1 text-[#8091B5]`}>Банк профиля </span>
              <span className={`${inter.className} text-[18px] font-bold text-[#002269]`}>{bankProfile?.selectBank}  </span>
            </p>
          </div>
          <div className='flex items-center gap-6 h-[88px] p-5 w-full rounded-[16px] bg-[#F9FAFB] mb-5 border border-[#eef2f9]'>
            ...
            <p className='flex flex-col'>
              ...
              <span className={`${inter.className} text-[18px] font-semibold text-[#002269]`}>{bankProfile?.phone}  </span>
            </p>
          </div>
        </div>
            ...
            <div className='w-[62%]'>
              <Link href={"/devices/" + bankProfile?.deviceId} className='bg-white some-shadow h-[70px] cursor-pointer flex justify-between items-center  w-full p-5 rounded-lg mb-3'>
                ...
                <div className='flex flex-col '>
                  <span className={`${inter.className} text-sm font-semibold text-[#002269] `}>{bankProfile?.title} </span>
                  <span className={`${inter.className} text-[10px] lg:text-[12px] text-[900] text-[#8091B5]`}>Модель:Нет данных  </span>
                </div>
                <FaChevronRight className='text-[#8091b5]' />
              </Link>
      ...
      <div className='w-full gap-6 grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1  justify-between'>
        <div className='flex justify-between h-[88px] p-5 w-full rounded-[16px] bg-[#F9FAFB] mb-5 border border-[#eef2f9]'>
          <div className='flex flex-col'>
            ...
            <p className='flex items-center gap-2 mt-1'>
              <span className={`${inter.className} text-sm md:text-[18px]  ${isChecked ? "text-[#0052FF]" : "text-[#002269]"}`}>Выкл</span>
              <input type="checkbox"
        ...
        <div className='flex items-center justify-between h-[88px] p-5 w-full rounded-[16px] bg-[#F9FAFB] mb-5 border border-[#eef2f9]'>
          <div className='flex flex-col'>
            <p className={`${inter.className} text-sm font-bold text-[#8091B5]`}>Турбо-режим</p>
            <p className='flex items-center gap-2 mt-1'>
              <span className={`${inter.className} text-[18px]  text-sm md:text-[18px]  ${isChecked1 ? "text-[#0052FF]" : "text-[#002269]"}`}>Прием на карты</span>
              <input type="checkbox"
      ...
      <div className='relative w-[80%] overflow-x-auto  mb-12 mt-3'>
        <div className="flex gap-2 min-w-max border-b-2 border-gray-200 relative after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-[30%] after:h-[2px] after:bg-blue-500 after:transition-all">
