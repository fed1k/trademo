  ...
  return (
    <div>
      <div className='flex items-center mb-8'>
        <p className={`${inter.className} text-[#002269] text-[18px] md:text-[32px] `}>User (FISH)</p>
            ...
            <div className='w-full min-h-[350px] p-5 rounded-[16px] bg-[#F9FAFB] mb-5 border border-[#eef2f9] '>
                ...
                <div className='flex gap-3 justify-between '>
                    <div className='relative text-center w-[38%]'>
                        ...
                        {/* <button className={`${inter.className} min-w-[100px] text-[10px] text-[700] text-[#FB6C6C] absolute mt-44 rounded-md   px-1 py-[6px] bg-[#FFEAEA]`}>Без регистрации</button> */}
                    </div>

                    <div className='w-[62%]'>
                        <div className='bg-white h-[70px] flex justify-between items-center  w-full p-5 rounded-lg mb-3'>
     ...
     <div className='relative w-[80%] overflow-x-auto  mb-12 mt-3'>
      ...
      <p className={`${inter.className} text-[18px] text-[#8091B5] mb-32`} >Реквизиты </p>
    </div>
  )
}
