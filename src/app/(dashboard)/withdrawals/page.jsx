...
const WithDrawalsPage = () => {
  ...
  return (
    <div>
      ...
      <div className="bg-[#fbfcfe] rounded-2xl space-y-2 border border-[#eef2f9] p-[13px_20px_15px] mb-6">
        <p className={`${inter.className} text-[#002269] text-[14px] font-medium mb-2`}>ОБЪЕМ ДОСТУПНЫХ ВЫПЛАТ</p>
        <p className={`font-sans text-[#002269] text-[20px] font-semibold mb-4`}>100 000 RUB</p>
      ...
      <div className='flex flex-col gap-2 md:flex-row'>
        <div className='flex flex-col w-full'>
          ...
          <button className="flex items-center justify-between bg-[#fbfcfe] px-4 py-2 rounded-lg shadow w-full mt-1">
