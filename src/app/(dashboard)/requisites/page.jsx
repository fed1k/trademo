        ...
        <div>
            ...
            {active &&
              <div className='w-full p-2 bg-[#F5F7F9] rounded-lg flex items-center gap-5 mt-5 '>
                    <div className='h-[154px] min-w-[280px] lg:min-w-[370px] py-4 px-5 rounded-[16px] bg-[#F9FAFB] my-5 border border-[#eef2f9]'>
                    ...
                    <p p className={`${inter.className} text-sm text-[#8091B5]`}>Банк: VTB • Россия: RUB</p>
                </div>
              </div>
            }
        </div>
