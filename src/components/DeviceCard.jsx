...
function DeviceCard({ user }) {
  ...
  console.log(user)
  return (
    <div onClick={() => router.push(`/devices/${user.id}`)} className='w-full py-2.5 mt-3 rounded-[16px] px-5 bg-[#FBFCFE] border-[1px] border-[#eef2f9] flex justify-between items-center hover:shadow-[0_2px_4px_rgba(0,0,0,0.1)] transition-shadow duration-300 cursor-pointer'>
